...
public class Aplicacao {
    ...
    public static void main(String[] args) {
        ...
        get("/carro/by-placa/:placa", (request, response) -> carroService.getByPlaca(request, response));
        
        get("/carro/garagem/:garagemId", (request, response) -> carroService.getByGaragem(request, response));
    }
}